...
//Main
data class Adapter(val kommuneNavn: String?, val fargekode: String?, val vaer: String?, val beskrivelse: String?, val ikonID: Int?, val aqiVal: Number?, var fav: Boolean?)
